...
SELECT R ,ADMIN_ANSWER_CONTENT,  OPT_ID, OPT_NO_SEQ,CUSTOMER_NO_SEQ ,CUSTOMER_TITLE, CUSTOMER_CONTENT, CUSTOMER_REGDATE
FROM(SELECT ROWNUM AS R ,ADMIN_ANSWER_CONTENT ,OPT_ID, OPT_NO_SEQ,CUSTOMER_NO_SEQ ,CUSTOMER_TITLE, CUSTOMER_CONTENT, CUSTOMER_REGDATE
FROM(SELECT M.OPT_ID,A.ADMIN_ANSWER_CONTENT ,S.OPT_NO_SEQ,S.CUSTOMER_NO_SEQ ,S.CUSTOMER_TITLE, S.CUSTOMER_CONTENT, S.CUSTOMER_REGDATE
FROM OPT_CUSTOMER_SERVICE S, OPT_MEMBER M , OPT_ADMIN_ANSWER A
