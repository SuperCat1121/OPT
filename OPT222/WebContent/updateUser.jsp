...
<body>
<h1>UPDATE</h1>
	<form id="updateFrm" method="post" name="update" onsubmit="return validate()" >
		...
		<table>
			<tr>
				<td><b>비밀번호</b></td>
				<td><input type="password" id="opt_pw" name="opt_pw" size="25" placeholder="비밀번호를 입력해주세요"></td>
			</tr>
			<tr>
				<td><b>이 름</b></td>
				<td><input type="text" id="opt_name" name="opt_name" size="25" value="${memdto.opt_name }"></td>
			</tr>
			<tr>
				<td><b>생년월일</b></td>
				<td><input type="text" id="opt_birth" name="opt_birth" size="25" value="${memdto.opt_birth }"></td>
			</tr>
			<tr>
				<td><b>전화번호</b></td>
				<td><input type="text" id="opt_phone" name="opt_phone" size="25" value="${memdto.opt_phone }"></td>
			</tr>
			<tr>
				<td><b>주 소</b></td>
				<td>
			...
			<tr>
				<td><b>이메일</b></td>
				<td>
					<input type="text" id="opt_email" name="opt_email" value="${memdto.opt_email }">
			...
			<tr>
				<td><input type="submit" value="정보수정" > <input type="reset" value="다시입력"></td>
			</tr>
		</table>
	</form>
</body>
