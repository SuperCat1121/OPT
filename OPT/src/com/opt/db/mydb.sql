...
CREATE TABLE OPT_BASKET(
    ...
    BASKET_COUNT NUMBER NOT NULL,             --장바구니 수량
    BASKET_PRICE VARCHAR2(100)                --상품가격
);

INSERT INTO OPT_BASKET VALUES(1,BASKETSEQ.NEXTVAL,0,0);
INSERT INTO OPT_BASKET VALUES(2,BASKETSEQ.NEXTVAL,0,0);
...
INSERT INTO OPT_PAYMENT VALUES(1,1,PAYSEQ.NEXTVAL,'홍길동','경기도 고양시 덕양구','010-1234-4567','경비실에 놔주세요',1);
INSERT INTO OPT_PAYMENT VALUES(2,2,PAYSEQ.NEXTVAL,'강호동','서울특별시 마포구','010-1423-4467','3시에 와주세요',1);
